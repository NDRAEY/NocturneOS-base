...
pub static CREATE_FILE_COMMAND_ENTRY: crate::ShellCommandEntry =
    ("mkfile", create_file, Some("Makes a new file"));
pub static CREATE_DIR_COMMAND_ENTRY: crate::ShellCommandEntry =
    ("mkdir", create_dir, Some("Makes a new directory"));
pub static REMOVE_FILE_COMMAND_ENTRY: crate::ShellCommandEntry =
    ("rmfile", remove_file, Some("Removes a file"));
pub static REMOVE_DIR_COMMAND_ENTRY: crate::ShellCommandEntry =
    ("rmdir", remove_dir, Some("Removes a directory"));
pub static COPY_FILE_COMMAND_ENTRY: crate::ShellCommandEntry =
